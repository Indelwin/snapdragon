...
#[derive(Debug, Deserialize)]
pub(crate) struct WorkerRegistrationParams {
    pub(crate) worker: GatewayWorkerRegistration,
}

#[derive(Debug, Deserialize)]
pub(crate) struct WorkerHeartbeatParams {
    pub(crate) heartbeat: GatewayWorkerHeartbeat,
}
